...
public class relative1_xpath {
	...
	driver.findElement(By.xpath("//div[1]/input[1]")).sendKeys("selenium A");
	Thread.sleep(3000);
	driver.findElement(By.xpath("//div[1]/input[2]")).clear();
	driver.findElement(By.xpath("//div[1]/input[2]")).sendKeys("selenium B");
	Thread.sleep(3000);
	driver.findElement(By.xpath("//div[2]/input[1]")).clear();
	driver.findElement(By.xpath("//div[2]/input[1]")).sendKeys("selenium C");
	Thread.sleep(3000);
	driver.findElement(By.xpath("//div[2]/input[2]")).clear();
	driver.findElement(By.xpath("//div[2]/input[2]")).sendKeys("selenium D");
	Thread.sleep(3000);
	driver.findElement(By.xpath("//div[1]/input[1]")).clear();
	driver.findElement(By.xpath("//div[1]/input[2]")).clear();
	driver.findElement(By.xpath("//div[2]/input[1]")).clear();
